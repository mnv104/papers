...
# Modified from the Rubber 1.1 bibtex module by Austin Clements to
# disable BibTeX crossrefs.  Rubber will look in the current directory
# for this module in preference to the system directories.
"""
